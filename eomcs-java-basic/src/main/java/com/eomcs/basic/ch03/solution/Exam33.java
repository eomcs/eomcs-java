...
public class Exam33 {
  public static void main(String[] args) {
    ...
    //- 유효자릿수가 7자리를 넘어가는 경우 값이 잘려 저장될 수 있다.
    ...
    //- 유효자릿수가 16자리를 넘어가는 경우 값이 잘려 저장될 수 있다.
...
//
//## 메모리에 값을 저장하기
//- 메모리에 값을 저장하려면 2진수여야 한다.
//- 어떤 유형의 값이든 2진수로 표현할 수 있다면 메모리에 저장할 수 있다.
//- 예) 빛을 저장하기
...
//
//## 부동소수점이 메모리에 저장되는 원리
//- 부동소수점을 저장하려면 먼저 2진수로 변환해야 한다.
//- 부동소수점을 가수부와 지수부로 분리하여 2진수로 변환한다. 
