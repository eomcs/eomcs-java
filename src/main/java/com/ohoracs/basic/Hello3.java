...
//## 실습
//1) 소스 디렉토리 생성
//- /src/main/java/com/ohoracs/basic 폴더를 생성한다.
//
//2) 소스 파일 생성
...
//3) 컴파일하기
//- 프로젝트 폴더에서 실행 할 때:
//  예) $ javac -d bin/main src/main/java/com/ohoracs/basic/Hello3.java
//- 클래스 파일은 패키지 폴더에 생성된다.
//  예) /bin/main/eom/ohoracs/basic//Hello3.class
//
//4) 실행하기
//- 프로젝트 폴더에서 실행 할 때:
//  java [-classpath | -cp] [루트 패키지가 있는 디렉토리 경로] [패키지 이름을 포함한 클래스 이름]
//  예) $ java -cp bin/main com.ohoracs.basic.Hello3
...
//  예) $ java -cp bin/main/com/ohoracs/basic Hello3  <== 실행 오류!
//
